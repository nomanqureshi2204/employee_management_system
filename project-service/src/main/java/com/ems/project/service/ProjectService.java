...
public class ProjectService {
	...
	public ClientResponseDto getClientByProjectId(String projectId) {
		
		Project project = repository.findByProjectId(projectId)
				.orElseThrow(()-> new ProjectNotFoundException("Project not found"));
		
		return clientFeign.getClientById(project.getClientId());
	}
	
	// get the project details from the client-id
	public List<ProjectResponseDto>getProjectsByClientId(String clientId){
